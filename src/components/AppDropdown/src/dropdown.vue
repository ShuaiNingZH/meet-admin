...
import type { AppDropdownProps, Axis, ContextMenuItemClickEmitArg } from './dropdown.ts';
import { appDropdownEmits } from './dropdown.ts';
...
const emits = defineEmits(appDropdownEmits);
